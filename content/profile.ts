...
캐나다 회계법인에서 고객 데이터를 분석해 문제를 진단하고 합의를 이끌었고, LG전자 SQA로서 복잡한 제품의 품질을 파고들며 현장과 개발자를 조율했습니다. 지금은 AI 부트캠프에서 그 경험을 토대로 멀티에이전트 워크플로우 자동화(FlowIt), NILM 에너지 진단(와트이쓔), 멀티모달 추천·광고 시스템(LG헬로비전 연계) 등 팀 프로젝트를 PM/조장으로 설계·구현했습니다.
