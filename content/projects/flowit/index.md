...
**PM · 백엔드 · 프론트엔드 (5인, 2026.05~06)** — 4개 스프린트 일정과 GitHub·Slack 협업을 주도하고, 아키텍처 설계·AI Native 하니스 엔지니어링·멀티에이전트 오케스트레이션 전반에 참여.
...
- **온톨로지 GraphRAG**: 평탄 벡터 검색의 한계(노드 호환성·필수 연결 미반영)를 Neo4j 그래프 확장(vector seed → 1-hop expand → ground truth 제약)으로 해소. **실행 불가능한(끊긴) 워크플로우 비율 23% → 0%, 생성 품질(QA) 0.45 → 0.75**.
